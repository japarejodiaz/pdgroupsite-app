...
import { ResponseServiceSingle, SolRequest, ResponseServiceSingleWithID } from '../../interfaces/info-page-services.interface';
import Swal from 'sweetalert2';
import { InfoPageDevelopmentProfesionalService } from '../../services/info-page-development-profesional.service';

@Component({
  selector: 'app-development-profesional',
...
export class DevelopmentProfesionalComponent implements OnInit {
  ...
  * @return Dvuelve un valor Booleano falso o verdadero
  */
  get subjectNoValido() {
    return (
  ...
  */
  guardarSolRecruitmentUs() {
    ...
    this._infoDevelopmentService.buscarDevelopProfesional_SolRequest(this.solRequest).subscribe
      ((response: ResponseServiceSingle) => {
        ...
        if (this.responseSolRequest.error == "true") {
          ...
          this._infoDevelopmentService.crearRegistroSolicitud("1", "1", this.solRequest)
